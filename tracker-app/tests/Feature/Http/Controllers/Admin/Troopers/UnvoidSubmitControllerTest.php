...
/**
 * @see \App\Http\Controllers\Admin\Troopers\UnvoidSubmitController
 */
class UnvoidSubmitControllerTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_invoke_denies_when_trooper_is_not_void(): void
    {
        $admin = Trooper::factory()->asAdministrator()->create();
