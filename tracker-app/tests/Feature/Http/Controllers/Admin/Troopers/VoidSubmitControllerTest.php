...
/**
 * @see \App\Http\Controllers\Admin\Troopers\VoidSubmitController
 */
class VoidSubmitControllerTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_invoke_requires_authentication(): void
    {
        ...
        $response = $this->post(route('admin.troopers.void', $trooper));
    ...
    public function test_invoke_voids_trooper_and_redirects_to_profile(): void
    {
