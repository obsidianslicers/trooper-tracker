...
class UpdateTroopersControllerTest extends TestCase
{
    ...
    public function test_invoke_displays_troopers_view(): void
    {
        // Arrange
    ...
    public function test_invoke_administrator_can_manage_troopers(): void
    {
        // Arrange
        $admin = Trooper::factory()->asAdministrator()->create();
        $event = Event::factory()->create();
    ...
    public function test_invoke_moderator_can_manage_moderated_event_troopers(): void
    {
        // Arrange
    ...
    public function test_invoke_moderator_cannot_manage_non_moderated_event_troopers(): void
    {
        // Arrange
        $moderator = Trooper::factory()->asModerator()->create();
    ...
    public function test_invoke_regular_trooper_cannot_manage_troopers(): void
    {
        // Arrange
