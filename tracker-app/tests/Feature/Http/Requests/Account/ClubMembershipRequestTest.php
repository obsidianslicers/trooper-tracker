...
class ClubMembershipRequestTest extends TestCase
{
    use RefreshDatabase;

    public function test_authorize_returns_true(): void
    {
        $subject = new ClubMembershipRequest;
    ...
    private function makeRequest(Trooper $trooper, array $payload = []): ClubMembershipRequest
    {
        $subject = new ClubMembershipRequest;
