...
class TrooperNextInLineTest extends TestCase
{
    ...
    public function test_envelope_contains_expected_subject(): void
    {
        ...
        $mail = new TrooperNextInLine($event_trooper);

        $this->assertSame('[TEST] Event Sign-Up Status Update - GOING', $mail->envelope()->subject);
    }
    ...
    public function test_content_contains_expected_view_and_relations(): void
    {
        ...
        $this->assertSame('emails.events.trooper-nextinline', $content->view);
