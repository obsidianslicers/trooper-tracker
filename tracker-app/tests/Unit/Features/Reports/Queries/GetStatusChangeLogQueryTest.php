...
class GetStatusChangeLogQueryTest extends TestCase
{
    public function test_construct_with_int_lookback(): void
    {
        ...
        // Act
        $subject = new GetStatusChangeLogQuery($moderator, $lookback);

        // Assert
        $this->assertInstanceOf(GetStatusChangeLogQuery::class, $subject);
    ...
    public function test_parse_lookback_with_int(): void
    {
        // Arrange
        $moderator = Trooper::factory()->make();
        $subject = new GetStatusChangeLogQuery($moderator, 30);
    ...
    public function test_parse_lookback_with_string(): void
    {
        // Arrange
        $moderator = Trooper::factory()->make();
        $subject = new GetStatusChangeLogQuery($moderator, '2025-01-01');
