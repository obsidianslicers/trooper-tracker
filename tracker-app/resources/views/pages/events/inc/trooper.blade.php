<div class="row mb-3 trooper-status-{{ $event_trooper->status->value }}">
    ...
    <div class="col-5 col-md-3 order-2 order-md-3 text-end">
        <div class="ps-3 ps-md-0">
            ...
            @elseif($event_shift->is_closed && $event_shift->shift_ends_at->isPast() && $event_trooper->status !== \App\Enums\EventTrooperStatus::CANCELLED && ($can_moderate || $event_trooper->canMarkAttendance(Auth::user())))
