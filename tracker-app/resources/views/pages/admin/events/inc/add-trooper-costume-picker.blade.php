<div class="border rounded p-2 mt-2">
    ...
    <div class="d-flex gap-2">
        <button class="btn btn-sm btn-success"
                ...
                hx-vals="js:{trooper_id: document.getElementById('admin-add-trooper-{{ $event_shift->id }}').value, costume_id: document.getElementById('admin-add-costume-{{ $event_shift->id }}').value}"
                hx-trigger="click">
