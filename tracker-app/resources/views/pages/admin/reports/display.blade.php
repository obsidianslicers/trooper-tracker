...
@section('content')
    ...
    <x-dashboard-cards x-data="Admin.cardNavigator()"
        ...
        <x-dashboard-card :label="'Event Counts per Trooper'"
                          ...
                          :url="'#'">
            <p>
                <b class="text-danger">TODO:</b> Troop Count per Trooper (Report to get amount of events attended by each trooper. You can do all or
                search
                by club)
            </p>
        </x-dashboard-card>
        <x-dashboard-card :label="'Donation Counts per Event'"
                          ...
                          :url="'#'">
            <p>
                <b class="text-danger">TODO:</b> Donation Count per Event (Donation Stats by date, can sort by charity event only and/or events with data
                only) this can be done as
        ...
        <x-dashboard-card :label="'Costume Troop Counts Between Dates'"
                          ...
                          :url="'#'">
            <p>
                <b class="text-danger">TODO:</b> Costume troop count between dates (Can see amount of events done in a costume between certain dates)
            </p>
        </x-dashboard-card>
        <x-dashboard-card :label="'Volunteers at Events'"
                          ...
                          :url="'#'">
            <p>
                <b class="text-danger">TODO:</b> Volunteers at Events (Total count of troopers at all events)
            </p>
        </x-dashboard-card>
        <x-dashboard-card :label="'Costume Used Most at Events'"
                          ...
                          :url="'#'">
            <p>
                <b class="text-danger">TODO:</b> Costume used most at Events (Report to see which costume was used the most at events between certain
                dates)
            </p>
        </x-dashboard-card>
        <x-dashboard-card :label="'Donations Raised'"
                          ...
                          :url="'#'">
            <p>
                <b class="text-danger">TODO:</b> Direct Doantions Raised &amp; Indirect Donations Raised
            </p>
        </x-dashboard-card>
        <x-dashboard-card :label="'Event Types Counts'"
                          ...
                          :url="'#'">
            <p>
                <b class="text-danger">TODO:</b> Counts of event-types
            </p>
        </x-dashboard-card>
        <x-dashboard-card :label="'Event Categories Counts'"
                          ...
                          :url="'#'">
            <p>
                <b class="text-danger">TODO:</b> Total events in Tracker
            </p>
        </x-dashboard-card>
    </x-dashboard-cards>
