<script lang="ts">
    ...
    import type { FaqFormViewModel } from "../models";
...
<SlimCard>
    <form onsubmit={vm.submit}>
        ...
        <InputContainer>
            <InputText label="Title" bind:value={vm.form.title} errors={vm.errors.title} />
        </InputContainer>
        ...
        <InputContainer>
            ...
            />
            <InputHelp>
                Leave blank for video-only items. Supports **bold**, *italic*, lists, and links.
            </InputHelp>
        </InputContainer>

        <InputContainer>
            <InputText label="Video URL" bind:value={vm.form.video_url} errors={vm.errors.video_url} />
            <InputHelp>
                Optional YouTube URL (watch or embed format). Leave blank for Q&amp;A items.
            </InputHelp>
        </InputContainer>
        ...
        <SubmitButtonContainer>
            <SubmitButton
                ...
                disabled={!vm.dirty}
            />
            <CancelButton href={getRoute("admin.faq.list")} />
        </SubmitButtonContainer>
    </form>
</SlimCard>
