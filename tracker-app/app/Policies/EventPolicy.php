...
class EventPolicy
{
     ...
     *
     * @param Trooper $trooper The authenticated user performing the action.
     * @param Event $subject The organization being updated.
     ...
     *
     * @param Trooper $trooper The authenticated user performing the action.
     * @param Event $subject The organization being deleted.
     ...
     *
     * @param Trooper $trooper The authenticated user performing the action.
     * @param Event $subject The organization being restored.
     * @return bool Always false.
     */
     ...
     *
     * @param Trooper $trooper The authenticated user performing the action.
     * @param Event $subject The organization being force-deleted.
     * @return bool Always false.
     */
     ...
     * @param Event $subject The organization being moderated.
